...
$objPHPExcel->getProperties()->setCreator("Thanh Hà Nguyễn")
							 ->setLastModifiedBy("Thanh Hà Nguyễn")
...
header('Content-Disposition: attachment;filename="markers_'.date('dmY_His').'.xlsx"');
