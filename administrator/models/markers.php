...
/**
 * Methods supporting a list of Marker records.
 */
class MarkerModelMarkers extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        // Load the parameters.
        $params = JComponentHelper::getParams('com_marker');
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__marker_marker` AS a');
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.title LIKE '.$search.'  OR  a.latitude LIKE '.$search.'  OR  a.longtitude LIKE '.$search.'  OR  a.altitude LIKE '.$search.' )');
            }
        }
